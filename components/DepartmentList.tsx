...
const DepartmentList = () => {
  return (
    <div className="py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 lg:auto-rows-max gap-6 container mx-auto px-12">
      <div className="bg-gradient-to-br from-[#FFF1F1] to-[#FFE4E4] border-none shadow-none transition-all duration-500 cursor-pointer group rounded-lg lg:col-span-1 lg:row-span-4 h-full flex flex-col relative">
        ...
        <div className="py-4 px-8">
          ...
          <Link href="/departments/" className="text-xl text-primary hidden lg:block">
      ...
      <div className="bg-gradient-to-br from-[#3F479E] to-[#5f60bc] block group text-white border-none shadow-none transition-all duration-300 px-8 py-5 lg:py-10 rounded-lg lg:col-span-1 lg:row-span-3 lg:row-start-5">
        <Link href="/departments/arimaha-bulshada/" >
          <h2 className="text-2xl font-semibold sm:font-bold mb-5 hover:underline">
      ...
      <div className="bg-[#3F479E] py-7 px-8 rounded-lg lg:col-span-1 lg:row-span-2 lg:col-start-2 lg:row-start-1 bg-gradient-to-br from-[#3F479E] to-[#5f60bc] block group text-white border-none shadow-none transition-all duration-300">
        <Link href="/departments/maamulka-maaliyadda">
          <h2 className="text-2xl font-medium sm:font-bold  tracking-wide mb-5 text-wrap hover:underline">
      ...
      <div className="bg-gradient-to-br from-[#FFF1F1] to-[#FFE4E4] border-none shadow-none transition-all duration-500 cursor-pointer hover:opacity-90 block group py-2 md:py-4 px-8 md:px-12 rounded-lg lg:col-span-1 lg:row-span-2 lg:col-start-3 lg:row-start-1">
        <Link href="/departments/wararka" className="">
          <h2 className="text-2xl font-medium sm:font-bold  tracking-wide mb-5 mt-4 text-primary group-hover:underline">
            Wararka
          </h2>
        </Link>
      ...
      <div className="bg-gradient-to-br from-[#3F479E] to-[#5f60bc] block group text-white border-none shadow-none transition-all duration-300 py-4 px-8 h-full rounded-lg lg:col-span-1 lg:col-start-2 lg:row-start-3">
        <Link href="">
      ...
      <div className="bg-gradient-to-br from-[#3F479E] to-[#5f60bc] block group text-white border-none shadow-none transition-all duration-300 py-6 px-10 rounded-lg lg:col-span-1 lg:row-span-2 lg:col-start-3 lg:row-start-3">
      ...
      <div className="bg-gradient-to-br from-[#FFF1F1] to-[#FFE4E4] border-none shadow-none transition-all duration-500 cursor-pointer hover:opacity-90 block group text-white py-5 px-8 rounded-lg hidden md:block sm:col-span-2 lg:col-span-3 lg:row-start-8  self-start">
  <h2 className="text-primary text-2xl font-bold text-left mb-5">
    Dagmooyinka Gobolka Banaadir
  </h2>
  <div className="w-full lg:w-fit col-span-3  sm:grid  sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-8 px-2  gap-10 lg:gap-8   ">
    {[
      "Boondheere",
      "Cabdicasiis",
      "Deyniile",
      ...
      <Link
        key={item}
        href="#"
        className="w-fit text-primary sm:text-xl lg:text-[1.1rem] hover:underline"
      >
        {item}
      </Link>
    ))}
