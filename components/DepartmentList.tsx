  ...
  return (
    <div className="container mx-auto px-4 lg:px-12 py-12">
      <div className="grid grid-cols-12 gap-6 ">
        ...
        <div className="col-span-12 lg:col-span-4 row-span-4 bg-gradient-to-br from-[#FFF1F1] to-[#FFE4E4] rounded-lg overflow-hidden  cursor-pointer group flex flex-col h-full relative">
          <div className="py-4 px-8">
            <Link href="/departments/xafiiska-ggb">
              <h2 className="sm:text-2xl lg:text-3xl text-3xl font-semibold sm:font-bold mb-0 md:mb-5 hover:underline text-primary">
                Xafiiska GGB ahna Duqa Magaalada
              </h2>
            </Link>
            <Link
              href="/departments/xafiiska-ggb/isgaarsiinta"
              className="text-[1.3rem] text-primary hover:underline block"
            >
        ...
        <div className="col-span-12 lg:col-span-4 row-span-2 bg-gradient-to-br from-[#3F479E] to-[#5758a9] rounded-lg py-6 px-8 text-white">
          <div className="flex justify-between gap-4 items-start">
            <Link href="/departments/maamulka-maaliyada">
              <h2 className="text-2xl lg:text-3xl font-bold hover:underline">
                {" "}
          ...
          <div className="mt-4 hidden lg:block space-y-2">
            ...
            <Link
              href="/departments/maamulka-maaliyada/canshuuraha/bixi"
              className="block text-[1.3rem] hover:underline"
            >
              Canshuuraha
            </Link>
        ...
        {/* Wararka - Medium Card */}
        <div className="col-span-12 lg:col-span-4 row-span-2 bg-gradient-to-br from-[#FFF1F1] to-[#FFE4E4] rounded-lg py-6 px-8">
          <div className="flex justify-between gap-4 items-start">
            <Link href="/departments/wararka">
              <h2 className="text-2xl lg:text-3xl font-bold text-primary hover:underline">
                Wararka
              </h2>
            </Link>
            <Rss
              className=" opacity-80 lg:hidden block  text-primary"
              size={35}
            />
          </div>
          <div className="mt-4 hidden lg:block space-y-2">
            <Link
              ...
              className="block text-[1.3rem] text-primary hover:underline"
            >
              TV-ga
            </Link>
            <Link
        ...
        <div className="col-span-12 lg:col-span-4 bg-gradient-to-br from-[#3F479E] to-[#5758a9] rounded-lg py-4 px-8 text-white">
          <div className="flex justify-between gap-4 items-center">
            <Link href="/departments/cabashooyinka">
              <h2 className="text-2xl lg:text-3xl font-semibold tracking-wide hover:underline">
                Cabashooyinka
              </h2>
            </Link>
        ...
        <div className="col-span-12 lg:col-span-4 row-span-2 bg-gradient-to-br from-[#3F479E] to-[#5758a9] text-white rounded-lg py-4 px-8">
          <div className="flex justify-between gap-4 items-start">
            <Link href="">
              <h2 className="text-2xl lg:text-3xl font-bold hover:underline">
                Ogeysiis Dadweyne
            ...
            <Megaphone
              className=" opacity-80 lg:hidden block   text-white"
              size={35}
            />
          </div>
          <div className="mt-4 hidden lg:block space-y-2">
            {[
              ...
              <Link
                key={index}
                href=""
                className="block text-[1.3rem] text-white hover:underline"
              >
                {item}
              </Link>
            ))}
        ...
        <div className="col-span-12 lg:col-span-4 row-span-4 bg-gradient-to-br from-[#FFF1F1] to-[#FFE4E4] rounded-lg py-4 px-8 text-primary">
          <div className="flex justify-between gap-4 items-start">
          ...
          <div className="mt-5 hidden lg:block space-y-3">
            {[
              ...
              <Link
                key={index}
                href={link.href}
                className="block text-[1.4rem] hover:underline"
              >
                {link.text}
              </Link>
            ))}
        ...
        <div className="col-span-12 lg:col-span-4 row-span-3 bg-gradient-to-br from-[#3F479E] to-[#5758a9] text-white rounded-lg py-4 px-8">
          <div className="flex justify-between gap-4 items-start">
            <Link href="/departments/amniga-siyaasada">
              <h2 className="text-2xl mt-4 lg:text-3xl font-bold  hover:underline">
        ...
        <div className="col-span-12 lg:col-span-4 row-span-3 bg-gradient-to-br from-[#FFF1F1] to-[#FFE4E4] rounded-lg py-6 px-8">
          <div className="flex justify-between gap-4 items-start">
        ...
        {/* Districts Section */}
        <div className="col-span-12 bg-gradient-to-br from-[#FFF1F1] to-[#FFE4E4] rounded-lg py-4 px-8">
