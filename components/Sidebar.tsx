...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`bg-gradient-to-b from-[#F1F1FB] to-[#F8F9FF] rounded-xl my-4 shadow-sm border border-[#E4E7EC] mt-24 pt-10 lg:mt-0 lg:pt-0 lg:sticky lg:top-32 lg:block fixed inset-0 lg:w-auto w-full ${
          ...
          <div>
            {currentDep.map((department, index) => (
              <div className="px-8 py-8" key={index}>
                <div 
                className="flex justify-between items-center gap-4 py-1 mb-6 rounded-md border-b">
                  <Link
