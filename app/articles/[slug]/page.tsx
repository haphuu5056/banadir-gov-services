...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive overview of the Benadir Regional Administration's commitment to sustainable development and progress in Mogadishu.",
}
  ...
  return (
    <article className="min-h-screen bg-white">
      ...
      <div className="relative h-[60vh] min-h-[400px] w-full">
        <Image
          src="https://images.unsplash.com/photo-1660518926158-1d47372a56bf?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Somali flag waving against blue sky"
          fill
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12">
          <div className="mx-auto max-w-3xl">
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
              Benadir Regional Administration Committed to Delivering Durable
            </h1>
          ...
          <div className="flex flex-row items-center  gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600">
                Senior Correspondent covering local government and urban development. Specialized in municipal affairs
        ...
        <div className="mx-auto max-w-7xl px-6 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {articles.slice(0, 3).map((i) => (
              <Link key={i.slug} href="#" className="group block">
                <article className="rounded-xl overflow-hidden bg-white shadow-sm transition-shadow hover:shadow-md">
                  ...
                  <div className="p-4">
                    <h3 className="text-lg font-semibold text-gray-900 group-hover:text-primary transition-colors">
                      Infrastructure Development Progress in Mogadishu
                    </h3>
                    <p className="mt-2 text-gray-600 line-clamp-2">
                      Latest updates on the ongoing infrastructure projects across the city...
                    </p>
                  </div>
                </article>
              </Link>
