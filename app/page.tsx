  ...
  return (
    <div>
      ...
      <div className=" py-12 grid grid-cols-3 auto-rows-max gap-6 container mx-auto px-12">
        ...
        <div className="bg-gradient-to-br from-[#3F479E] to-[#5f60bc] block group text-white border-none shadow-none transition-all duration-300 px-8 py-10 rounded-lg  col-span-1 row-span-3 row-start-5 hover:from-[#4338CA] hover:to-[#6366F1] ">
