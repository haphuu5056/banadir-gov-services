        ...
        {department.items?.map((subDept, index) => (
          ...
          >
            ...
            <div className="relative flex justify-between gap-5 items-center">
              <div>
              <h2 className="text-3xl font-semibold mb-2 group-hover:opacity-90 transition-opacity">{subDept.title}</h2>
              </div>
              {subDept.icon && <subDept.icon size={50} className="font-extralight opacity-75"/>}
